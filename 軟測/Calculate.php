...
if($client->validationName()=="ok") $name = $client->Getname();
else $name = $client->validationName();
//email
$client->Setemail($_POST['email']);
if($client->validationEmail()=="ok") $email = $client->Getemail();
else $email = $client->validationEmail();
//plan
$client->Setplan($_POST['text']);
if($client->validationPlan()=="ok") $plan = $client->Getplan();
else $plan = $client->validationPlan();
//hours
$client->Sethours($_POST['text-1']);
if($client->validationHours()=="ok") $hours = $client->Gethours();
else $hours = $client->validationHours();
//4G/5G
$client->SetG($_POST['text-2']);
if($client->validationG()=="ok") $G = $client->GetG();
else $G = $client->validationG();
//money
$money = $client->validationCal();
?>